...
class HoughTransform:
    ...
    def img_lane_lines(self):
        ...
        img_lines = np.zeros((img_roi_mask.shape[0], img_roi_mask.shape[1], 3), dtype=np.uint8)
        ...
        return cv2.addWeighted(self.img_rgb, self.alpha, img_lines, self.beta, self.gamma)
